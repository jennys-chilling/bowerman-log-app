...
const Slider = React.forwardRef(({ className, trackClassName, rangeClassName, thumbClassName, ...props }, ref) => (
  <SliderPrimitive.Root
    ...
    <SliderPrimitive.Track
      className={cn("relative h-1.5 w-full grow overflow-hidden rounded-full", trackClassName || "bg-primary/20")}>
      <SliderPrimitive.Range className={cn("absolute h-full", rangeClassName || "bg-primary")} />
    </SliderPrimitive.Track>
    <SliderPrimitive.Thumb
      className={cn(
        ...
        thumbClassName || "border-primary/50 focus-visible:ring-ring"
      )} />
  </SliderPrimitive.Root>
))
